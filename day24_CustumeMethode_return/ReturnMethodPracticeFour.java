package day24_CustumeMethode_return;

public class ReturnMethodPracticeFour {
    //creat a method that can be removee duplicated characters from a string and return the new value
